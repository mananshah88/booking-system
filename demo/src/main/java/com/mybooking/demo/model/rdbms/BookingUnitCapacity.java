...
@Entity
@Table(name = "bookingunit_capacity")
public class BookingUnitCapacity extends BaseModel {
	...
	public BookingUnitCapacity(Long id, BookingType bookingType, Double price, String status, Integer created,
